...
#
# conv_system.tcl: Tcl script for re-creating project 'conv_system'
#
# Generated by Vivado on Mon Dec 01 16:16:34 CST 2025
...
#
# 1. This project restoration tcl script (conv_system.tcl) that was generated.
#
...
set _xil_proj_name_ "conv_system"
...
set script_file "conv_system.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/conv_system"]"
...
set_property -name "top" -value "conv_system_wrapper" -objects $obj
...
# Proc to create BD conv_system
proc cr_bd_conv_system { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name conv_system
...
\
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN]
  ...
  assign_bd_address -offset 0xC2000000 -range 0x00040000 -target_address_space [get_bd_addr_spaces axi_cdma_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] -force
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.545713",
   "Default View_TopLeft":"9,4",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.5.8 2022-09-21 7111 VDI=41 GEI=38 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2010 -y 50 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2010 -y 80 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1520 -y 110 -defaultsOSRD
preplace inst axi_cdma_0 -pg 1 -lvl 3 -x 860 -y 380 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 5 -x 1520 -y 390 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 560 -y 360 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 210 -y 600 -defaultsOSRD
preplace inst axi_bram_ctrl_0_bram -pg 1 -lvl 6 -x 1870 -y 400 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1150 -y 390 -defaultsOSRD
preplace inst axi_bram_ctrl_1 -pg 1 -lvl 5 -x 1520 -y 530 -defaultsOSRD
preplace inst axi_bram_ctrl_1_bram -pg 1 -lvl 6 -x 1870 -y 540 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 490 410 500 710 470 1000 470 1300 230 1740
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 500 390J 610 NJ 610 NJ 610 NJ 610 1730
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 400 510 720 480 1010 480 1310
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 5 1 NJ 390
preplace netloc axi_bram_ctrl_1_BRAM_PORTA 1 5 1 NJ 530
preplace netloc axi_cdma_0_M_AXI 1 3 1 N 370
preplace netloc axi_smc_M00_AXI 1 4 1 N 370
preplace netloc axi_smc_M01_AXI 1 4 1 1290 100n
preplace netloc axi_smc_M02_AXI 1 4 1 1290 410n
preplace netloc processing_system7_0_DDR 1 5 2 1750J 50 NJ
preplace netloc processing_system7_0_FIXED_IO 1 5 2 NJ 80 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 220 NJ 220 NJ 220 NJ 220 1750
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N 350
levelinfo -pg 1 0 210 560 860 1150 1520 1870 2010
pagesize -pg 1 -db -bbox -sgen 0 0 2120 700
"
}
...
# End of cr_bd_conv_system()

cr_bd_conv_system ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files conv_system.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files conv_system.bd ] 
set_property IS_ENABLED "1" [get_files conv_system.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files conv_system.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files conv_system.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files conv_system.bd ] 
set_property PFM_NAME "" [get_files conv_system.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files conv_system.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files conv_system.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files conv_system.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files conv_system.bd ] 
set_property USED_IN_SIMULATION "1" [get_files conv_system.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files conv_system.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list conv_system.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/conv_system/conv_system.gen/sources_1/bd/conv_system/hdl/conv_system_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list conv_system.bd]] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/conv_system.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/conv_system.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/conv_system.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
